...
class Indexer:
    ...
    def generate_inverted_index(self, K):
        ...
        for f in files:
            ...
            while(count<= K):
                ...
                for ngram ,frequency in freq_dist.items():
                    ...
                    if ngram not in inverted_index:
                        inverted_index[ngram] = [(docID, frequency)]
            ...
            out_put_file = open(dirname(__file__)+'/inverted_indexes/unigrams_inverted_index_for_'+ query + '.txt', 'w') # for uni-grams
